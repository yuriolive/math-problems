...
Three roles worth delegating, each one a job this repository has already got wrong once:
...
session. Treat these three files as specifications of the roles, useful to any agent
runner, rather than as a wired-up feature.
